...
| **R7** | Schema drift + registros inválidos | `VARIANT` (drift estrutural impossível) ou `rescue` → `_rescued_data`; inválidos → `<collection>_quarentena`; ver [DECISOES D2](docs/DECISOES_TECNICAS.md) |
